class DataProvider(object):
    ...
    def __init__(self):
        ...
        .. py:attribute:: scenario
           ...
           Parser class from :py:mod:`magnolia.scenarios` magnolia uses to encapsulate records

        .. py:attribute:: map
           :type: str

           Name of function used to map records from OAI-PMH into MAPv4. Can come from :py:mod:`magnolia.maps` or be
           defined elsewhere such as a custom map from the Custom Map Directory defined in ``magnolia.cfg``
