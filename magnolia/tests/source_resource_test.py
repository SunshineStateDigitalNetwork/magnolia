...
class SourceResourceRecordTestCase(unittest.TestCase):
    ...
    def setUp(self):
        from magnolia.source_resource import Record
        self.rec = Record()
        self.rec['spam'] = 'eggs'
...
class SourceResourceSourceResourceTestCase(unittest.TestCase):
    ...
    def test_source_resource_rights_error(self):
        from magnolia import SourceResourceRequiredElementException
...
class SourceResourceRecordGroupTestCase(unittest.TestCase):
    ...
    def setUp(self):
        from magnolia import RecordGroup
        self.rg = RecordGroup()
    ...
    def test_record_group_load_file_ext_error(self):
        from magnolia import RecordGroup, RecordGroupFileExtensionError
        rg = RecordGroup()
