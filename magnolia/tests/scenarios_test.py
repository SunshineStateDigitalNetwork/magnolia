...
class XMLScenarioTestCase(unittest.TestCase):
    ...
    def setUp(self):
        from magnolia import XMLScenario
...
class MagnoliaRecordTestCase(unittest.TestCase):

    def setUp(self):
        from magnolia import XMLScenario, XMLRecord
        self.scenario = XMLScenario(os.path.join(test_dir_path, 'test_data/DCdebugSmall.xml'))
        self.record = XMLRecord(self.scenario.records[0])

    def test_magnolia_record_harvest_id(self):
...
#     magnolia_record_suite = unittest.makeSuite(MagnoliaRecordTestCase, 'test')
...
#     test_suite = unittest.TestSuite((xml_scenario_suite, magnolia_record_suite, dc_record_suite, qdc_record_suite, mods_record_suite))
#     return test_suite
