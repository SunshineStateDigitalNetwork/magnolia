...
Provides magnolia information required during the transformation process. Each provider begins with a section header ``[<provider>]``

**CONFIG ENTRIES FOR EACH SECTION**

* ``scenario`` - :py:mod:`magnolia.scenario` to apply to data provider
